...
class DDPG(object):
    ...
    def _build_a(self, s, scope, trainable):
        with tf.variable_scope(scope):
            net = tf.layers.dense(s, 36, activation=tf.nn.tanh, name='l1', trainable=trainable)
            net1 = tf.layers.dense(net,36, activation = tf.nn.tanh, name = 'l2', trainable = trainable)
